...
const core = require("../nats-base-client/idleheartbeat");
...
})(ConsumerDebugEvents = exports.ConsumerDebugEvents || (exports.ConsumerDebugEvents = {}));
class PullConsumerMessagesImpl extends queued_iterator_1.QueuedIteratorImpl {
    ...
    constructor(c, opts, refilling = false) {
        ...
        this.timeout = null;
        this.inbox = (0, core_1.createInbox)();
        this.listeners = [];
