    ...
    purgeDeletes(olderMillis = 30 * 60 * 1000) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (() => __awaiter(this, void 0, void 0, function* () {
                var _a, e_1, _b, _c;
                try {
                    for (var _d = true, i_1 = __asyncValues(i), i_1_1; i_1_1 = yield i_1.next(), _a = i_1_1.done, !_a;) {
                        _c = i_1_1.value;
                        _d = false;
                        try {
                            const e = _c;
    ...
    _buildCC(k, history = false, opts = {}) {
        ...
        return Object.assign({
            "deliver_policy": history
                ? jsapi_types_1.DeliverPolicy.All
                : jsapi_types_1.DeliverPolicy.LastPerSubject,
    ...
    keys(k = ">") {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (() => __awaiter(this, void 0, void 0, function* () {
                ...
                var _d;
                try {
                    for (var _e = true, sub_1 = __asyncValues(sub), sub_1_1; sub_1_1 = yield sub_1.next(), _a = sub_1_1.done, !_a;) {
                        _c = sub_1_1.value;
                        _e = false;
                        try {
                            const jm = _c;
